...
const nextConfig = {
    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Access-Control-Allow-Headers', value: 'Content-Type, Authorization, x-uploadthing-package, x-uploadthing-version' },
  ...
  // Simplified webpack configuration to avoid runtime errors
  ...
  env: {
    ...
    UPLOADTHING_REGION: process.env.UPLOADTHING_REGION,
