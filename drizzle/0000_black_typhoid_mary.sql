...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "blogComments" ADD CONSTRAINT "blogComments_postId_blogPosts_id_fk" FOREIGN KEY ("postId") REFERENCES "public"."blogPosts"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "blogPosts" ADD CONSTRAINT "blogPosts_authorId_user_id_fk" FOREIGN KEY ("authorId") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "blog_post_slug_idx" ON "blogPosts" ("slug");--> statement-breakpoint
